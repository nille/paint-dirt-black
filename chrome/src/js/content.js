...
var blokksvalues = [];	
 ...
 jq(document).ready(function(){
	...
	var font_eof = chrome.extension.getURL('css/font/webfonts/BLOKKRegular.eot');
	var font_woff = chrome.extension.getURL('css/font/webfonts/BLOKKRegular.woff');
	var font_svg = chrome.extension.getURL('css/font/webfonts/BLOKKRegular.svg');
